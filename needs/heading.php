<body>
  <div class="header">
    <div class="logo">
      <a href="<?php echo DIR; ?>"><img src="<?php echo DIR; ?>/images/needs/glyph-instagram.png" alt="Hashtag"></a>
    </div>
    <div class="search_box">
      <?php if($universal->isLoggedIn()){ ?>
      <input type="text" name="" placeholder="Search Hashtag" spellcheck="false" autocomplete="off" class="search" autofocus>

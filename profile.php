...
<?php
  $title = "{$noti->titleNoti()} @{$universal->GETsDetails($get_id, "username")} ({$universal->GETsDetails($get_id, "firstname")} {$universal->GETsDetails($get_id, "surname")}) • Hashtag";
  $keywords = "{$universal->GETsDetails($get_id, "username")}, {$universal->GETsDetails($get_id, "firstname")}, {$universal->GETsDetails($get_id, "surname")}, Hashtag, Share and capture world's moments";
  $desc = "Connect with {$universal->GETsDetails($get_id, "username")}'s profile • Hashtag";
?>
